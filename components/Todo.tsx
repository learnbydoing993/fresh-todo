...
export function Todo({todo, onTodoRemove, onTodoEdit}: TodoProps) {
  ...
  return (
    <div class="mb-5 h-12 rounded-md bg-gray-50 flex justify-between items-center content-between">
      {isEdit ? 
        (
          <form onSubmit={onEditTodo}>
            <input 
            id="editTodo" name="editTodo" type="text" 
      ...
      <div class="flex">
        ...
        class="px-3 flex h-full justify-center items-center">
